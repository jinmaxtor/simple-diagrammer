...
!function (a, b) {
    ...
    return function (a) {
        ...
        function f(a) {
            ...
            for (var c = ('string' == typeof a ? a : '').split(/[\s,]+/), d = c.length, e = 0; e < d; e++) {
        ...
        b.protocol = 4, b.types = ['CONNECT', 'DISCONNECT', 'EVENT', 'ACK', 'ERROR', 'BINARY_EVENT', 'BINARY_ACK'], b.CONNECT = 0, b.DISCONNECT = 1, b.EVENT = 2, b.ACK = 3, b.ERROR = 4, b.BINARY_EVENT = 5, b.BINARY_ACK = 6, b.Encoder = d, b.Decoder = g, d.prototype.encode = function (a, c) {
            if (a.type !== b.EVENT && a.type !== b.ACK || !n(a.data) || (a.type = a.type === b.EVENT ? b.BINARY_EVENT : b.BINARY_ACK), l('encoding packet %j', a), b.BINARY_EVENT === a.type || b.BINARY_ACK === a.type) {
                f(a, c);
            } else {
                var d = e(a);
                c([d]);
        ...
        a.exports = d, d.prototype.emitAll = function () {
            ...
            for (var a in this.nsps) {
                o.call(this.nsps, a) && this.nsps[a].emit.apply(this.nsps[a], arguments);
            }
        ...
        (function (a) {
            ...
            function e(a, c, d) {
                if (!c) {
                    return b.encodeBase64Packet(a, d);
                }
            ...
            b.encodePacket = function (b, c, f, h) {
                ...
                var c = t[a.charAt(0)];
                if (!j) {
                    return {type: c, data: {base64: !0, data: a.substr(1)}};
                }
        ...
        (function (a, e) {
            !function (f) {
                ...
                function l(a, b) {
                    b = b || {};
                    for (var c, d = !1 !== b.strict, e = g(a), f = e.length, h = -1, i = ''; ++h < f;) {
                        c = e[h], i += k(c, d);
                    }
                    return i;
                }
        ...
        !function () {
            ...
            b.encode = function (b) {
                ...
                for (b = 0; b < i; b += 4) {
                    d = c[a.charCodeAt(b)], e = c[a.charCodeAt(b + 1)], f = c[a.charCodeAt(b + 2)], g = c[a.charCodeAt(b + 3)], l[j++] = d << 2 | e >> 4, l[j++] = (15 & e) << 4 | f >> 2, l[j++] = (3 & f) << 6 | 63 & g;
                }
                return k;
            };
        }();
