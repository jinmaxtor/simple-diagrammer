...
Menus.prototype.init = function () {
    ...
    this.put('arrange', new Menu(mxUtils.bind(this, function (menu, parent) {
        ...
        let arrangeMenuOptions = ['-', 'group', 'ungroup', 'removeFromGroup', '-', 'clearWaypoints', 'autosize'];
        arrangeMenuOptions = ['-', 'group', 'ungroup', 'removeFromGroup', '-', 'clearWaypoints'];

        this.addMenuItems(menu, arrangeMenuOptions, parent);
    ...
    this.put('view', new Menu(mxUtils.bind(this, function (menu, parent) {
        let viewMenuOptions = ['outline', 'layers', '-', 'pageView', 'pageScale', '-', 'scrollbars', 'tooltips', '-',
            'grid', 'guides', '-', 'connectionArrows', 'connectionPoints', '-',
            'resetView', 'zoomIn', 'zoomOut'];

        viewMenuOptions = ['scrollbars', '-', 'resetView'];
        this.addMenuItems(menu, ((this.editorUi.format != null) ? ['formatPanel'] : []).concat(viewMenuOptions, parent));
    })));
    ...
    this.put('file', new Menu(mxUtils.bind(this, function (menu, parent) {
        let fileMenuOptions = ['new', 'open', '-', 'save', 'saveAs', '-', 'import', 'export', '-', 'pageSetup', 'print'];
        fileMenuOptions = ['save', '-', 'import', 'export', '-', 'pageSetup', 'print'];
        this.addMenuItems(menu, fileMenuOptions, parent);
    })));

    this.put('edit', new Menu(mxUtils.bind(this, function (menu, parent) {
        let editMenuOptions = ['undo', 'redo', '-', 'cut', 'copy', 'paste', 'delete', '-', 'duplicate', '-',
            'editData', 'editTooltip', '-', 'editStyle', '-', 'edit', '-', 'editLink', 'openLink', '-',
            'selectVertices', 'selectEdges', 'selectAll', 'selectNone', '-', 'lockUnlock'];

        editMenuOptions = ['undo', 'redo', '-', 'cut', 'copy', 'paste', 'delete', '-', 'duplicate', '-',
            'edit', '-', 'selectVertices', 'selectEdges', 'selectAll', 'selectNone', '-', 'lockUnlock'];
        this.addMenuItems(menu, editMenuOptions);
    })));
    ...
    this.put('help', new Menu(mxUtils.bind(this, function (menu, parent) {
        let helpMenuOptions = ['help', '-', 'about'];
        this.addMenuItems(menu, helpMenuOptions);
    })));
};
