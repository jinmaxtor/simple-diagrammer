 ...
 */
EditorUi = function (editor, container, lightbox, senderDiagramData) {
    ...
    this.setEnabled = function (status) {
        this.editor.graph.setEnabled(status);
    };

    this.getXml = function (fileName = 'diagram.xml') {
    ...
    this.setXml = function (xmlData, fileName = 'graph.xml') {
        try {
    ...
    this.sendDiagramData = function () {
        try {
            let currentXml = this.getXml();
            if (typeof this.sender === 'function') {
                this.sender(currentXml);
            }
            // console.debug('diagramData: ', currentXml);
        } catch (e) {
            console.error('ocurrió un error al enviar los datos del diagrama');
        }
    };

    graph.updateXml = mxUtils.bind(this, function () {
        // console.debug('printing current xml');
...
EditorUi.prototype.hsplitPosition = hsplitPosition;
...
EditorUi.prototype.initClipboard = function () {
    ...
    this.editor.graph.cellEditor.stopEditing = function (cell, trigger) {
        cellEditorStopEditing.apply(this, arguments);
        ui.updatePasteActionStates();
        console.debug('Stop editing cell content excecuted!');
        // editorUi.sendDiagramData();
    };
...
EditorUi.prototype.redo = function () {
    try {
        ...
        console.debug('redo action excecuted!');
    } catch (e) {
        // ignore all errors
    }
};
...
EditorUi.prototype.undo = function () {
    try {
        ...
        console.debug('undo action excecuted!');
    } catch (e) {
        // ignore all errors
    }
};
