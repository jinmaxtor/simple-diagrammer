...
Sidebar.prototype.init = function () {
    ...
    // La propiedad addStencilsToIndex = true y expanded false para incluir stencilPalette en los resultados de busqueda
    ...
    this.addFlowchartCommandsPalette(dir, true);
...
if (urlParams['sidebar-entries'] != 'large') {
    ...
    Sidebar.prototype.thumbWidth = thumbWidth;
    Sidebar.prototype.thumbHeight = thumbHeight;
 ...
 */
Sidebar.prototype.addStencilsToIndex = false;
...
/**
 * Adds the custom flowchart commands palette to the sidebar.
 */
Sidebar.prototype.addFlowchartCommandsPalette = function (dir, expanded) {
    this.setCurrentSearchEntryLibrary('flowchart_custom');
    this.addStencilPalette('flowchart_custom', 'Comandos', dir + '/flowchart_custom.xml',
        ';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2',
        null, null, 1, null, null, expanded);
    this.setCurrentSearchEntryLibrary();
};
            ...
            if (cells.length > 0) {
                ...
                if (!graph.isCellLocked(target || graph.getDefaultParent())) {
                    ...
                    try {
                        ...
                        graph.model.endUpdate();
                        console.debug('cell inserted excecuted!');
                        this.editorUi.sendDiagramData();
                    }
 ...
 */
Sidebar.prototype.addStencilPalette = function (id, title, stencilFile, style, ignore, onInit, scale = 1, tags, customFns, expanded = false) {
