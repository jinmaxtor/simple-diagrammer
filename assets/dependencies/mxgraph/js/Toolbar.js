const renderViewOptionTooltip = false;
const renderZoomInOutButtons = true;
const renderUndoRedoButtons = true;
const renderDeleteButton = true;
const renderToFrontBackButtons = false;
const renderStyleShapeOptions = false;
const renderConnectionShapeOptions = false;
const renderLineStyleOptions = true;
const renderInsertLinkImageTooltip = false;
...
Toolbar.prototype.init = function () {
    ...
    if (sw >= 700 && renderViewOptionTooltip) {
    ...
    if (sw >= 420 && renderZoomInOutButtons) {
    ...
    if (sw >= 400 && (renderConnectionShapeOptions || renderLineStyleOptions)) {

        // Conection
        if (sw >= 440 && renderConnectionShapeOptions) {
    ...
    if (renderInsertLinkImageTooltip) {
